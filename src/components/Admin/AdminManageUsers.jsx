...
const AdminManageUsers = () => {
    ...
    if (!user || !user.primaryEmailAddress || user.primaryEmailAddress.emailAddress !== 'pandurangmopgar7410@gmail.com') {
        return (
            <div className={`flex items-center justify-center min-h-screen w-full ${darkMode ? 'bg-gray-900' : 'bg-gray-100'}`}>
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className={`flex flex-col min-h-screen w-full ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}
        >
